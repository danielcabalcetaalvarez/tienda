...
public class ProductoController {
    ...
    public ProductoController(ProductoService productoService, CategoryService categoryService, MessageSource messageSource) {
    ...
    public String listado(Model model) {
        ...
        var categorias = categoryService.getCategorias(true);
